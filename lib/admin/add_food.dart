    ...
    return Scaffold(
      appBar: AppBar(
        leading: GestureDetector(
          ...
          child: Icon(Icons.arrow_back_ios_new_outlined, color: Color(0xFF373886),)),
          centerTitle: true,
          title: Text("Add Item", style: AppWidget.HeaderlineTextFeildStyle(),),
      ),
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Upload the Item Image", style: AppWidget.boldTextFeildStyle(),),
